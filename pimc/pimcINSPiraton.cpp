...
//    vector<vector<int> > n_resolved_SWAP_histograms, Pn;
//
...
//    vector<ofstream> n_resolved_SWAP_histogram_files, Pn_files;
//    ofstream n_resolved_SWAP_histogram_file, Pn_file;
//
...
//    vector<int> n_A; // total particles in subsystem on each replica
//
...
//    else {
//        string SWAP_histogram_name,Pn_name;
//        vector<string> n_resolved_SWAP_histogram_names,Pn_names;
//
...
//            "can_"+"SWAP.dat";
//
//            Pn_name=to_string(L)+"_"+to_string(N)+"_"+
//            to_string(l_A)+"_"+to_string(D)+"D_"+
//            to_string(U)+"_"+to_string(beta)+"_"+
//            to_string(t)+"_"+to_string(sweeps)+"_"+
//            to_string(seed)+"_"+
...
//            }
//
//            // Create filenames of SWAP histograms for each lA-Sector
//            for (int i=1; i<=m_A; i++){
//                n_resolved_SWAP_histogram_names.push_back(
//                to_string(L)+"_"+to_string(N)+"_"+
//                to_string(l_A)+"_"+to_string(D)+"D_"+
...
//                        std::fill(n_A.begin(),n_A.end(),0);
//                        for (int REP=0; REP<num_replicas; REP++){
//                            get_fock_state(beta/2.0,M,fock_state_at_half_plus[REP],paths[REP]);
//                            for (int i=0; i<num_swaps; i++){
//                                n_A[REP]+=fock_state_at_half_plus[REP][sub_sites[i]];
//                            }
//                        }
//                        n_resolved_SWAP_histograms[n_A[0]][num_swaps]+=1;
//
//                        if (num_swaps==0){
//                            for (int REP=0; REP<num_replicas; REP++){
//                                std::fill(n_A.begin(),n_A.end(),0);
...
//                                        n_A[REP]+=fock_state_at_half_plus[REP][sub_sites[m_A_primed-1]];
//                                        Pn[n_A[REP]][m_A_primed-1]+=1;
//                                }
//                            }
//                        }
//
...
//                    }
//
//                    // Save current mA-resolved Pn histogram to file
//                    for (int i=0; i<=N; i++){
//                        for (int j=1; j<=m_A; j++){
//                            Pn_files[i]<<
//                            fixed<<setprecision(17)<<
