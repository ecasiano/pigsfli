...
The code is written in c++ and makes use of <a href="http://www.boost.org/">boost</a> libraries and the <a href="https://github.com/jarro2783/cxxopts">cxxopts</a> header-only library for command-line arguments.
