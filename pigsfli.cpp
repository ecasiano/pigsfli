...
int main(int argc, char **argv)
{
    ...
    options.add_options()("h,help", "Print usage")("D", "Dimension of hypercubic lattice", cxxopts::value<int>())("L", "Linear size of hypercube", cxxopts::value<int>())("N", "Total number of particles", cxxopts::value<int>())("U", "Interaction potential", cxxopts::value<double>())("l", "Linear size of hypercubic subregion", cxxopts::value<int>())("sweeps", "Number of sweeps before attempting measurements",
                                                                                                                                                                                                                                                                                                                                                              cxxopts::value<unsigned long long int>()->default_value("10000000"))("beta", "Set length of imaginary time", cxxopts::value<double>())("mu", "Chemical potential", cxxopts::value<double>()->default_value("-3.0"))("Z", "Diagonal fraction", cxxopts::value<double>()->default_value("48"))("dZ", "Size of half-window around desired Z", cxxopts::value<double>()->default_value("3"))("t", "Tunneling parameter", cxxopts::value<double>()->default_value("1.0"))("canonical", "set to false for grand canonical simulation",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   cxxopts::value<bool>()->default_value("true"))("seed", "Random seed value", cxxopts::value<int>()->default_value("0"))("sweeps-pre", "Number sweeps for each pre-equilibration step",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::value<unsigned long long int>()->default_value("1000000"))("bin-size", "Number of measurements per bin", cxxopts::value<int>()->default_value("10"))("bins-wanted", "Number of bins desired in data file", cxxopts::value<int>()->default_value("1000"))("subgeometry", "Shape of subregion: square OR strip",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            cxxopts::value<string>()->default_value("square"))("trial-state", "Trial wavefunction: constant,non-interacting,gutzwiller,jastrow",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               cxxopts::value<string>()->default_value("constant"))("kappa", "Variational parameter (Gutzwiller)", cxxopts::value<double>()->default_value("-12345.6789"))("v", "Variational parameter (Jastrow)", cxxopts::value<double>()->default_value("-12345.6789"))("num-replicas", "Number of replicas", cxxopts::value<int>()->default_value("2"))("measurement-frequency", "Measurements will be performed every other this amount", cxxopts::value<int>()->default_value("1"))("rng", "Random Number Generator type", cxxopts::value<string>()->default_value("pimc_mt19937"))("restart", "continue simulation from a loaded rng state",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::value<bool>()->default_value("false"))("get-s2n", "compute symmetry-resolved Rényi enropies",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::value<bool>()->default_value("false"))("get-Pn", "compute local particle number probability distribution of partition A (will be computed if get-s2n is on)",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::value<bool>()->default_value("false"))("get-PN", "compute total particle number distribution",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          cxxopts::value<bool>()->default_value("false"))("get-n", "compute subregion-size-resolved local particle number density (and squared)",
        ...
        ("boundary", "Boundary condition: pbc or obc",
         cxxopts::value<string>()->default_value("pbc"))("no-worms", "Do simulation with only non-worm moves.",
                                                         cxxopts::value<bool>()->default_value("false"));
    ...
    if (trial_state != "constant" && trial_state != "non-interacting" && trial_state != "gutzwiller")
    {
    ...
    {
        cerr << endl
             << "ERROR: Invalid random Number Generator!" << endl
             << endl;
    ...
    unsigned long long int insertZero_kink_antikink_attempts = 0, insertZero_kink_antikink_accepts = 0;
    unsigned long long int deleteZero_kink_antikink_attempts = 0, deleteZero_kink_antikink_accepts = 0;

    unsigned long long int insertBeta_kink_antikink_attempts = 0, insertBeta_kink_antikink_accepts = 0;
    unsigned long long int deleteBeta_kink_antikink_attempts = 0, deleteBeta_kink_antikink_accepts = 0;
    ...
    // Check if worms were selected in simulations with more than 1 replica
    if (num_replicas > 1 && no_worms)
    {
        cout << "ERROR: Need worms for simulations with > 1 replicas." << endl;
        exit(1);
    }
    ...
    if (l_A > L)
    {
        cout << "ERROR: Please choose l <= L" << endl;
        exit(1);
    }
    m_A = pow(l_A, D);
    if (subgeometry == "square")
    {
        m_A = pow(l_A, D);
    }
    else if (subgeometry == "strip")
    {
        m_A = L * l_A;
    } // l_A: max width of rectangle
 ...
 Path-Integral Ground State (Monte Carlo) For Lattice Implementations
    ...
    */
    ...
    if (!restart)
        cout << "Stage (1/3): Determining mu and eta..." << endl
             << endl;
    else
        cout << "Stage (1/3): RESTARTED SIMULATION: mu,eta calibration not needed." << endl
             << endl;
    ...
    if (!restart)
    {
        ...
        { // stage0:mu,eta stage1:eta fine tuning
            ...
            while (true)
            {
                ...
                for (unsigned long long int m_pre = 0; m_pre < sweeps_pre; m_pre++)
                {
                    ...
                    { // insertBeta
                        insertBeta_2(paths[0], num_kinks[0], head_idx[0], tail_idx[0],
                                     ...
                                     dummy_counter, dummy_counter,
                                     dummy_counter, dummy_counter, *rng_ptr,
                                     trial_state, kappa, fock_state_at_beta);
                    }
                    else if (label == 5)
                    { // deleteBeta
                ...
                // cout << "---------------------------------------" << endl;
                cout << "<N>: " << N_mean_pre << " ; N samples: " << N_data.size() << endl
                     << endl;

                // Eta equilibration
                // if (!eta_fine_tuning_stage){ // Coarse calibration
                if (0)
                { // Coarse calibration of eta. Off for now. Slow.
                    N_flats_mean /= N_flats_samples;
                    eta = 1 / sqrt(N_flats_mean);
                }
                else
                { // Fine tuning (want Z-dZ < Z-frac < Z+dZ)
                    if (!no_worms)
                    {
                        if (Z_frac >= (Z - dZ) && Z_frac <= (Z + dZ))
                        {
                            eta_fine_tuning_complete = true;
                        }
                        else if (Z_frac > Z + dZ)
                        {
                            eta *= 1.45;
                            eta_fine_tuning_complete = false;
                        }
                        else
                        {
                            eta *= 0.5;
                ...
                if (N_target_in_bins)
                {
                    ...
                    if (peak_idx == N_idx && P_N.size() > 0 && P_N[peak_idx - 1] / P_N[peak_idx] < 0.66 && P_N[peak_idx + 1] / P_N[peak_idx] < 0.66 && abs(N_mean_pre - N) / N < 0.33 && at_least_one_iteration)
                    {
                        ...
                        if (!no_worms)
                        {
                            if (!eta_fine_tuning_stage)
                            {
                                cout << "Fine tuning eta... (Want: " << (Z - dZ) * 100.0 << "% < diagonal fraction < " << (Z + dZ) * 100.0 << "%)" << endl
                                     << endl;
                    ...
                    else
                    {
                        ...
                        { // Peak is 100% at N... Yes. It can happen.
    ...
    else
    {
        ...
        if (canonical)
        { // name of file if canonical simulation
        ...
        { // name of file if grand canonical simulation
        ...
        if (!restart)
        {
            ...
            if (get_s2n)
            {
                ...
                if (!SWAP_histogram_file)
                { // fifle couldn't be opened
    ...
    if (measure_tau_resolved_estimators)
    {
        tr_kinetic_energy.push_back(vector<double>(measurement_centers.size(), 0.0));
        tr_diagonal_energy.push_back(vector<double>(measurement_centers.size(), 0.0));
    }
    ...
    if (!restart)
        cout << "Stage (2/3): Equilibrating..." << endl
             << endl;
    else
        cout << "Stage (2/3): RESTARTED SIMULATION: Equilibration not needed" << endl
             << endl;
    ...
    while (bins_written < bins_wanted)
    {
        ...
        for (int r = 0; r < num_replicas; r++)
        {
            ...
            { // insertZero
                insertZero_2(paths[r], num_kinks[r], head_idx[r], tail_idx[r],
                             ...
                             trial_state, kappa, fock_state_at_zero);
            }
            else if (label == 3)
            { // deleteZero
        ...
        if (m % (sweep * measurement_frequency) == 0 && (m >= sweeps * 1.00 || restart))
        {
                ...
                { // if no worm
                    ...
                    { // grand canonical
                        ...
                        state_file = save_paths(D, L, N, l_A, U, t,
                                                beta, bin_size,
                                                bins_wanted, seed, subgeometry, mu,
                                                eta, num_replicas,
                    ...
                    if (N_zero[r] == N && N_beta[r] == N && canonical)
                    { // canonical measurement
                        ...
                        // Measure n and n^2
                        if (get_n)
                        { // this is for num_replicas < 1 for now
                            for (int REP = 0; REP < num_replicas; REP++)
                            {
                                std::fill(n_A[REP].begin(),
                                          n_A[REP].end(), 0);
                        ...
                        if (writing_ctr == bin_size)
                        {
                            ...
                            kinetic_energy_file << fixed << setprecision(17) << kinetic_energy / bin_size << endl;
                            diagonal_energy_file << fixed << setprecision(17) << diagonal_energy / bin_size << endl;
                            ...
                            if (measure_tau_resolved_estimators)
                            {
                                ...
                                {
                                    tr_kinetic_energy_file[r] << fixed << setprecision(17) << tr_kinetic_energy[r][i] / bin_size << " ";

                                    tr_diagonal_energy_file[r] << fixed << setprecision(17) << tr_diagonal_energy[r][i] / bin_size << " ";
                                }
                            ...
                            if (get_Pn)
                            {
                                ...
                                for (int i = 1; i <= m_A; i++)
                                {
                                    for (int j = 0; j <= N; j++)
                                    {
                                        Pn_files[i - 1] << fixed << setprecision(17) << Pn[i - 1][j] << " ";
                                    }
                                    Pn_files[i - 1] << endl;
                            ...
                            if (get_n)
                            {
                                ...
                                for (int i = 1; i <= m_A; i++)
                                {
                                    n_file << fixed << setprecision(17) << n_A_accum[i - 1] * 1.0 / bin_size << " ";

                                    n_squared_file << fixed << setprecision(17) << n_A_squared_accum[i - 1] * 1.0 / bin_size << " ";
                                }
                                n_file << endl;
                                n_squared_file << endl;
            ...
            if (num_replicas > 1)
            {
                ...
                {
                    if (N_zero[0] == N && N_beta[0] == N && N_zero[1] == N && N_beta[1] == N)
                    {
                        ...
                        if (get_s2n)
                        {
                            ...
                            { // num_swaps>0
                                ...
                                for (int REP = 0; REP < num_replicas; REP++)
                                { // THIS LOOP IS ACTUALLY NOT NECESSARY. If we made it here, n[0]==n[1].
                                ...
                                if (n_A[0][num_swaps - 1] ==
                                    n_A[1][num_swaps - 1])
                                { // Not necessary. When there are SWAPs, n0 and n1 are the same.
                ...
                if (writing_ctr == bin_size)
                {
                    ...
                    for (int i = 0; i <= m_A; i++)
                    {
                        SWAP_histogram_file << fixed << setprecision(17) << SWAP_histogram[i] << " ";
                    }
                    ...
                    if (get_s2n)
                    {
                        ...
                        for (int i = 1; i <= m_A; i++)
                        {
                            for (int j = 0; j <= N; j++)
                            {
                                Pn_squared_files[i - 1] << fixed << setprecision(17) << Pn_squared[i - 1][j] << " ";
                            }
                        ...
                        for (int i = 1; i <= m_A; i++)
                        {
                            for (int j = 0; j <= N; j++)
                            {
                                SWAPn_histogram_files[i - 1] << fixed << setprecision(17) << SWAPn_histograms[i - 1][j] << " ";
                            }
    ...
    cout << endl
         << "-------- Detailed Balance --------" << endl;

    cout << endl
         << "Insert Worm: " << insert_worm_accepts << "/" << insert_worm_attempts << endl;
    cout << "Delete Worm: " << delete_worm_accepts << "/" << delete_worm_attempts << endl;

    cout << endl
         << "Insert Anti: " << insert_anti_accepts << "/" << insert_anti_attempts << endl;
    cout << "Delete Anti: " << delete_anti_accepts << "/" << delete_anti_attempts << endl;

    cout << endl
         << "InsertZero Worm: " << insertZero_worm_accepts << "/" << insertZero_worm_attempts << endl;
    cout << "DeleteZero Worm: " << deleteZero_worm_accepts << "/" << deleteZero_worm_attempts << endl;

    cout << endl
         << "InsertZero Anti: " << insertZero_anti_accepts << "/" << insertZero_anti_attempts << endl;
    cout << "DeleteZero Anti: " << deleteZero_anti_accepts << "/" << deleteZero_anti_attempts << endl;

    cout << endl
         << "InsertBeta Worm: " << insertBeta_worm_accepts << "/" << insertBeta_worm_attempts << endl;
    cout << "DeleteBeta Worm: " << deleteBeta_worm_accepts << "/" << deleteBeta_worm_attempts << endl;

    cout << endl
         << "InsertBeta Anti: " << insertBeta_anti_accepts << "/" << insertBeta_anti_attempts << endl;
    cout << "DeleteBeta Anti: " << deleteBeta_anti_accepts << "/" << deleteBeta_anti_attempts << endl;

    cout << endl
         << "Advance Head: " << advance_head_accepts << "/" << advance_head_attempts << endl;
    cout << "Recede  Head: " << recede_head_accepts << "/" << recede_head_attempts << endl;

    cout << endl
         << "Advance Tail: " << advance_tail_accepts << "/" << advance_tail_attempts << endl;
    cout << "Recede  Tail: " << recede_tail_accepts << "/" << recede_tail_attempts << endl;

    cout << endl
         << "IKBH: " << ikbh_accepts << "/" << ikbh_attempts << endl;
    cout << "DKBH: " << dkbh_accepts << "/" << dkbh_attempts << endl;

    cout << endl
         << "IKAH: " << ikah_accepts << "/" << ikah_attempts << endl;
    cout << "DKAH: " << dkah_accepts << "/" << dkah_attempts << endl;

    cout << endl
         << "IKBT: " << ikbt_accepts << "/" << ikbt_attempts << endl;
    cout << "DKBT: " << dkbt_accepts << "/" << dkbt_attempts << endl;

    cout << endl
         << "IKAT: " << ikat_accepts << "/" << ikat_attempts << endl;
    cout << "DKAT: " << dkat_accepts << "/" << dkat_attempts << endl;

    cout << endl
         << "Advance Kink: " << advance_kink_accepts << "/" << advance_kink_attempts << endl;
    cout << "Recede  Kink: " << recede_kink_accepts << "/" << recede_kink_attempts << endl;

    cout << endl
         << "Insert Kink-Antikink: " << insert_kink_antikink_accepts << "/" << insert_kink_antikink_attempts << endl;
    cout << "Delete Kink-Antikink: " << delete_kink_antikink_accepts << "/" << delete_kink_antikink_attempts << endl;

    cout << endl
         << "InsertZero Kink-Antikink: " << insertZero_kink_antikink_accepts << "/" << insertZero_kink_antikink_attempts << endl;
    cout << "DeleteZero Kink-Antikink: " << deleteZero_kink_antikink_accepts << "/" << deleteZero_kink_antikink_attempts << endl;

    cout << endl
         << "InsertBeta Kink-Antikink: " << insertBeta_kink_antikink_accepts << "/" << insertBeta_kink_antikink_attempts << endl;
    cout << "DeleteBeta Kink-Antikink: " << deleteBeta_kink_antikink_accepts << "/" << deleteBeta_kink_antikink_attempts << endl;

    cout << endl
         << "SWAP: " << insert_swap_kink_accepts << "/" << insert_swap_kink_attempts << endl;
    cout << "UNSWAP: " << delete_swap_kink_accepts << "/" << delete_swap_kink_attempts << endl;

    cout << endl
         << "SWAP Advance Head: " << swap_advance_head_accepts << "/" << swap_advance_head_attempts << endl;
    cout << "SWAP Recede Head: " << swap_recede_head_accepts << "/" << swap_recede_head_attempts << endl;

    cout << endl
         << "SWAP Advance Tail: " << swap_advance_tail_accepts << "/" << swap_advance_tail_attempts << endl;
    cout << "SWAP Recede Tail: " << swap_recede_tail_accepts << "/" << swap_recede_tail_attempts << endl;
    ...
    cout << endl
         << "Elapsed time: " << duration << " seconds" << endl;

    cout << "num_kinks: " << num_kinks[0] << endl;

    cout << endl;
    cout << "--- paths (end of simulation) ---" << endl;
    for (int i = 0; i < num_kinks[0]; i++)
    {
        cout << "i: " << i << " " << paths[0][i] << endl;
    }
    cout << "N_tracker = " << N_tracker[0] << endl;
    cout << "head & tail: " << head_idx[0] << " " << tail_idx[0] << endl;
    cout << "last_kinks = ";
    for (int i = 0; i < M; i++)
    {
        cout << last_kinks[0][i] << " ";
    ...
    cout << endl;
    cout << "num_kinks = " << num_kinks[0] << endl;
    cout << "N_beta = " << N_beta[0] << endl;
    cout << "N_zero = " << N_zero[0] << endl;
    cout << endl;
